...
from .views import book_appointment, get_available_time_slots, user_info, edit_booking, delete_booking, change_booking_status
...
urlpatterns = [
    ...
    path('booking/status_change/<int:booking_id>/<str:new_status>/', change_booking_status, name='change_booking_status'),
]
